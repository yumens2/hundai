...
public class MatchResultCreator {
    private static final int[] ret = new int[2];
    /**
     * 국소적 비교 결과를 계산한다.
     * @param number 상위 숫자
     ...
     * @return 국지적 비교 결과
     */
    private static int[] getLocalResult (int number, int idx, Numbers n) {
        ret[0] = 0;
        ret[1] = 0;
     ...
     * @return 비교 결과
     */
    public static MatchResult getCompareResult(Numbers n1, Numbers n2) {
        int strike = 0;
        int ball = 0;
