...
2. 숫자 입력 문구를 출력하고 3자리 수를 입력 받기
    * 입력값이 서로 다른 수로 이루어진 3자리의 수가 아닐 경우 IllegalArgumentException 출력

3. 입력값을 컴퓨터가 선택한 숫자와 비교하여 힌트를 출력
...
5. 게임 종료 시, 게임 재시작 및 프로그램 종료 선택 문구를 출력
    * 1 입력 => 게임 재시작
    * 2 입력 => 프로그램 종료
